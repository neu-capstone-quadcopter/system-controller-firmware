...
namespace board {
	...
	void cc1120_init() {
		...
		Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, CC1120_GPIO3_INTPORT, 1 << CC1120_GPIO3_PIN);
		Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, CC1120_GPIO2_INTPORT, CC1120_GPIO2_PIN);
		Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, CC1120_GPIO0_INTPORT, CC1120_GPIO0_PIN);
	}

	bool cc1120_is_gpio3_int(void) {
		if (Chip_GPIOINT_GetStatusFalling(LPC_GPIOINT, CC1120_GPIO3_INTPORT) & (1 << CC1120_GPIO3_PIN)) {
			Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, CC1120_GPIO3_INTPORT, 1 << CC1120_GPIO3_PIN);
			return true;
		}
		return false;
	...
	bool cc1120_is_gpio2_int(void) {
		if (Chip_GPIOINT_GetStatusFalling(LPC_GPIOINT, CC1120_GPIO2_INTPORT) & (1 << CC1120_GPIO2_PIN)) {
			Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, CC1120_GPIO2_INTPORT, 1 << CC1120_GPIO2_PIN);
			return true;
		}
		return false;
	...
	bool cc1120_is_gpio0_int(void) {
		if (Chip_GPIOINT_GetStatusFalling(LPC_GPIOINT, CC1120_GPIO0_INTPORT) & (1 << CC1120_GPIO0_PIN)) {
			Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, CC1120_GPIO0_INTPORT, 1 << CC1120_GPIO0_PIN);
			return true;
		}
		return false;
